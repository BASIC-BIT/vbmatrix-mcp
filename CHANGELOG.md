...
- Added live-tested `vbmatrix_inspect_routes` and `vbmatrix_inspect_slots` for bounded read-only route, slot, label, and engine/master inspection before live changes.
