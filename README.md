...
For setup failures or support reports, start with `docs/troubleshooting.md`. It lists safe diagnostics to run and which local audio details should stay redacted.
